...
2. Enter your own Anthropic (Claude) API key. When you click reformat, the extracted text (plus
   the rulebook) is sent **directly from your browser to Anthropic's Claude API** — no server
   this project runs ever sees your files or your key. Standard Anthropic usage charges from
   your own account apply per reformat.
...
assets/app.js     UI wiring + the Claude API call
...
convenience; it is never transmitted anywhere except directly to Anthropic's API from your
browser.
